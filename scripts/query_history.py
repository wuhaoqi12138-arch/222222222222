...
RECORDS_PATH = REFERENCES / "history-records.jsonl"
CASES_PATH = REFERENCES / "history-cases.jsonl"
MANIFEST_PATH = REFERENCES / "source-manifest.json"
BUILD_SUMMARY_PATH = REFERENCES / "build-summary.json"
RAW_CLEAR_PATH = REFERENCES / "raw-clear-corpus.jsonl"
RAW_AGREEMENT_PATH = REFERENCES / "raw-agreement-corpus.jsonl"
...
def main() -> int:
    if not RECORDS_PATH.exists():
        print(f"Missing history data: {RECORDS_PATH}", file=sys.stderr)
        return 2
